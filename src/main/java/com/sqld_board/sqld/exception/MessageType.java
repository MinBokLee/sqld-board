...
public enum MessageType {
    ...
    LOGOUT_SUCCESS("success.logout.code", "success.logout.msg"),
    ...
    DELETE_COMMENT("success.deleteComment.code", "success.deleteComment.msg"),
    UPDATE_COMMENT("success.updateComment.code", "success.updateComment.msg"),
